 ...
 */
namespace Ecombricks\VendorQuote\Observer\Framework\Model\AbstractModel;
...
class BeforeDelete extends \Ecombricks\Vendor\Observer\Framework\Model\AbstractModel\BeforeDelete\Vendor
{
    ...
    public function __construct(
        ...
        $targetedTypes = ['quote' => \Magento\Quote\Model\Quote::class]
    )
    {
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $this->vendorResource->deleteRelatedEntities($object, 'ecombricks_vendor_quote');
        return $this;
    }
